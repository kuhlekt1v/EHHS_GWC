...
def guess_word():
    ...
    # COMMENT OUT REST OF CODE AND DEMO APP TO STUDENTS BEFORE CONTINUING.

    # Walk through the if else above first, before continuing this part.
    # Now you notice when we try to play the game it will immediate quit after we guess.
    # To avoid this we need to use a while loop
